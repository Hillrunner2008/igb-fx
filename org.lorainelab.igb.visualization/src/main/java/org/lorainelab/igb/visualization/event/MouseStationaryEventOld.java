...
public abstract class MouseStationaryEventOld extends InputEvent {

    private static final long serialVersionUID = 1L;

    private static final End DEFAULT_END = new End(null, null);

    public static final EventType<MouseStationaryEventOld> ANY
            = new EventType<>(InputEvent.ANY, "MOUSE_STATIONARY_ANY");
    public static final EventType<MouseStationaryEventOld> MOUSE_STATIONARY_BEGIN
            = new EventType<>(ANY, "MOUSE_STATIONARY_BEGIN");
    public static final EventType<MouseStationaryEventOld> MOUSE_STATIONARY_END
            = new EventType<>(ANY, "MOUSE_STATIONARY_END");

    public static final MouseStationaryEventOld beginAt(Point2D screenPos) {
        return new Begin(null, null, screenPos);
    }

    public static final MouseStationaryEventOld end() {
        return DEFAULT_END;
    }

    private static class Begin extends MouseStationaryEventOld {
    ...
    private static class End extends MouseStationaryEventOld {
    ...
    private MouseStationaryEventOld(
            Object source,
            EventTarget target,
            EventType<? extends MouseStationaryEventOld> type) {
