...
//
//    public MainViewer(MainViewerProps appProps) {
//        this.props = appProps;
//        mouseEvents = Lists.newArrayList();
//        this.state = new MainViewerState();
//        initializeCanvas();
...
//
//    @Override
//    public MainViewer beforeComponentReady() {
//        return this;
//    }
//
//    @Subscribe
...
//        }
//
//        MainViewerState state = this.getState()
...
//        LOG.info(MainViewer.this.toString());
...
//        AppStore.getStore().unsubscribe(this);
