 ...
 * @since JavaFX 2.0
 */
public abstract class MinimalChart extends Region {
    ...
    private ObjectProperty<Side> titleSide = new StyleableObjectProperty<Side>(Side.TOP) {
        ...
        @Override
        public CssMetaData<MinimalChart,Side> getCssMetaData() {
    ...
    private final BooleanProperty legendVisible = new StyleableBooleanProperty(true) {
        ...
        @Override
        public CssMetaData<MinimalChart,Boolean> getCssMetaData() {
    ...
    private static class StyleableProperties {
        private static final CssMetaData<MinimalChart,Side> TITLE_SIDE =
            new CssMetaData<MinimalChart,Side>("-fx-title-side",
                new EnumConverter<Side>(Side.class),
                Side.TOP) {

            @Override
            public boolean isSettable(MinimalChart node) {
                return node.titleSide == null || !node.titleSide.isBound();
            }

            @Override
            public StyleableProperty<Side> getStyleableProperty(MinimalChart node) {
                return (StyleableProperty<Side>)(WritableValue<Side>)node.titleSideProperty();
            }
        };

        private static final CssMetaData<MinimalChart,Side> LEGEND_SIDE =
            new CssMetaData<MinimalChart,Side>("-fx-legend-side",
                new EnumConverter<Side>(Side.class),
                Side.BOTTOM) {
        ...
        private static final CssMetaData<MinimalChart,Boolean> LEGEND_VISIBLE =
            new CssMetaData<MinimalChart,Boolean>("-fx-legend-visible",
            ...
            @Override
            public StyleableProperty<Boolean> getStyleableProperty(MinimalChart node) {
