 ...
 * @author dcnorris
 */
public abstract class MinimalAxis<T> extends Region {
    ...
    private ObjectProperty<Side> side = new StyleableObjectProperty<Side>() {
        ...
        @Override
        public CssMetaData<MinimalAxis<?>, Side> getCssMetaData() {
            return StyleableProperties.SIDE;
        }

        @Override
        public Object getBean() {
            return MinimalAxis.this;
        }
    ...
    private BooleanProperty tickMarkVisible = new StyleableBooleanProperty(true) {
        ...
        @Override
        public CssMetaData<MinimalAxis<?>, Boolean> getCssMetaData() {
    ...
    private DoubleProperty tickLength = new StyleableDoubleProperty(8) {
        ...
        @Override
        public CssMetaData<MinimalAxis<?>, Number> getCssMetaData() {
...
//                autoRangeValid = false;
    ...
    private ObjectProperty<Font> tickLabelFont = new StyleableObjectProperty<Font>(Font.font("System", 8)) {
        ...
        @Override
        public CssMetaData<MinimalAxis<?>, Font> getCssMetaData() {
    ...
    private ObjectProperty<Paint> tickLabelFill = new StyleableObjectProperty<Paint>(Color.BLACK) {
        ...
        @Override
        public CssMetaData<MinimalAxis<?>, Paint> getCssMetaData() {
...
//                System.out.println("tick pos at : "+tickIndex+" = "+xPos);
    ...
    private static class StyleableProperties {
        ...
        private static final CssMetaData<MinimalAxis<?>, Side> SIDE
                = new CssMetaData<MinimalAxis<?>, Side>("-fx-side",
                        new EnumConverter<Side>(Side.class)) {

            @Override
            public boolean isSettable(MinimalAxis<?> n) {
                return n.side == null || !n.side.isBound();
            }

            @SuppressWarnings("unchecked") // sideProperty() is StyleableProperty<Side>
            @Override
            public StyleableProperty<Side> getStyleableProperty(MinimalAxis<?> n) {
                return (StyleableProperty<Side>) n.sideProperty();
            }
        };

        private static final CssMetaData<MinimalAxis<?>, Number> TICK_LENGTH
                = new CssMetaData<MinimalAxis<?>, Number>("-fx-tick-length",
            ...
            @Override
            public StyleableProperty<Number> getStyleableProperty(MinimalAxis<?> n) {
                return (StyleableProperty<Number>) (WritableValue<Number>) n.tickLengthProperty();
            }
        };

        private static final CssMetaData<MinimalAxis<?>, Font> TICK_LABEL_FONT
                = new FontCssMetaData<MinimalAxis<?>>("-fx-tick-label-font",
            ...
            @Override
            public StyleableProperty<Font> getStyleableProperty(MinimalAxis<?> n) {
                return (StyleableProperty<Font>) n.tickLabelFontProperty();
            }
        };

        private static final CssMetaData<MinimalAxis<?>, Paint> TICK_LABEL_FILL
                = new CssMetaData<MinimalAxis<?>, Paint>("-fx-tick-label-fill",
            ...
            @Override
            public StyleableProperty<Paint> getStyleableProperty(MinimalAxis<?> n) {
                return (StyleableProperty<Paint>) n.tickLabelFillProperty();
            }
        };

        private static final CssMetaData<MinimalAxis<?>, Number> TICK_LABEL_TICK_GAP
                = new CssMetaData<MinimalAxis<?>, Number>("-fx-tick-label-gap",
        ...
        private static final CssMetaData<MinimalAxis<?>, Boolean> TICK_MARK_VISIBLE
                = new CssMetaData<MinimalAxis<?>, Boolean>("-fx-tick-mark-visible",
            ...
            @Override
            public StyleableProperty<Boolean> getStyleableProperty(MinimalAxis<?> n) {
                return (StyleableProperty<Boolean>) (WritableValue<Boolean>) n.tickMarkVisibleProperty();
            }
        };

        private static final CssMetaData<MinimalAxis<?>, Boolean> TICK_LABELS_VISIBLE
                = new CssMetaData<MinimalAxis<?>, Boolean>("-fx-tick-labels-visible",
                        BooleanConverter.getInstance(), Boolean.TRUE) {
    ...
    /**
     * pseudo-class indicating this is a vertical Top side MinimalAxis.
     */
    private static final PseudoClass TOP_PSEUDOCLASS_STATE
            = PseudoClass.getPseudoClass("top");
    /**
     * pseudo-class indicating this is a vertical Bottom side MinimalAxis.
     */
    private static final PseudoClass BOTTOM_PSEUDOCLASS_STATE
            = PseudoClass.getPseudoClass("bottom");
    /**
     * pseudo-class indicating this is a vertical Left side MinimalAxis.
     */
    private static final PseudoClass LEFT_PSEUDOCLASS_STATE
            = PseudoClass.getPseudoClass("left");
    /**
     * pseudo-class indicating this is a vertical Right side MinimalAxis.
     */
