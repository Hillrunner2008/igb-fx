 ...
 * @author dcnorris
 */
public abstract class AbstractIgbAction implements IgbAction {
    ...
    public AbstractIgbAction() {
    }

    public AbstractIgbAction(String text) {
        setText(text);
    }

    public AbstractIgbAction(String text, Node graphic) {
        setText(text);
        setGraphic(graphic);
    }

    public AbstractIgbAction(String text, Node graphic, KeyCombination accelerator) {
        setText(text);
        setGraphic(graphic);
