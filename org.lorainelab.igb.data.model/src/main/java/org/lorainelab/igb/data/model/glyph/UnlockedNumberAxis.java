 ...
 * @author dcnorris
 */
public class UnlockedNumberAxis extends ValueAxis<Number>{
   ...
   private Object currentAnimationID;
    ...
    private BooleanProperty forceZeroInRange = new BooleanPropertyBase(true) {
        ...
        public Object getBean() {
            return UnlockedNumberAxis.this;
        }
    ...
    private DoubleProperty tickUnit = new StyleableDoubleProperty(5) {
        ...
        @Override
        public CssMetaData<UnlockedNumberAxis,Number> getCssMetaData() {
     ...
     */
    public UnlockedNumberAxis() {}
    public UnlockedNumberAxis(double lowerBound, double upperBound) {   super(lowerBound, upperBound);}
     ...
     */
    public UnlockedNumberAxis(double lowerBound, double upperBound, double tickUnit) {
     ...
     * @param tickUnit The tick unit, ie space between tickmarks
     */
    public UnlockedNumberAxis(String axisLabel, double lowerBound, double upperBound, double tickUnit) {
        super(lowerBound, upperBound);
        setTickUnit(tickUnit);
        setLabel(axisLabel);
    }
        ...
        if(animate) {
            ...
            currentAnimationID = animator.animate(
                new KeyFrame(Duration.ZERO,
                        ...
                        new KeyValue(new ReadOnlyDoubleWrapper(getScale()), getScale())
                ),
                new KeyFrame(Duration.millis(700),
                        new KeyValue(currentLowerBound, lowerBound),
                        new KeyValue(new ReadOnlyDoubleWrapper(getScale()), scale)
                )
            );
        } else {
    ...
    private static class StyleableProperties {
        private static final CssMetaData<UnlockedNumberAxis,Number> TICK_UNIT =
            new CssMetaData<UnlockedNumberAxis,Number>("-fx-tick-unit",
                SizeConverter.getInstance(), 5.0) {

            @Override
            public boolean isSettable(UnlockedNumberAxis n) {
                return n.tickUnit == null || !n.tickUnit.isBound();
            }

            @Override
            public StyleableProperty<Number> getStyleableProperty(UnlockedNumberAxis n) {
    ...
    public static class DefaultFormatter extends StringConverter<Number> {
         ...
         */
        public DefaultFormatter(final UnlockedNumberAxis axis) {
         ...
         */
        public DefaultFormatter(UnlockedNumberAxis axis, String prefix, String suffix) {
            this(axis);
            this.prefix = prefix;
            this.suffix = suffix;
        }
