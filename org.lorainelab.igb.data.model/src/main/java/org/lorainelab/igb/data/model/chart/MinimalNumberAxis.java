 ...
 * @author dcnorris
 */
public class MinimalNumberAxis extends MinimalValueAxis<Number> {
    ...
    private DoubleProperty tickUnit = new StyleableDoubleProperty(5) {
        ...
        @Override
        public CssMetaData<MinimalNumberAxis, Number> getCssMetaData() {
     ...
     */
    public MinimalNumberAxis(double lowerBound, double upperBound, double tickUnit) {
     ...
     * @param tickUnit The tick unit, ie space between tickmarks
     */
    public MinimalNumberAxis(String axisLabel, double lowerBound, double upperBound, double tickUnit) {
        super(lowerBound, upperBound);
        setTickUnit(tickUnit);
        setLabel(axisLabel);
    }
    ...
    protected List<Number> calculateTickValues(double length, Object range) {
        ...
        if (lowerBound == upperBound) {
            ...
            if (((upperBound - lowerBound) / tickUnit) > 2000) {
                ...
                System.err.println("Warning we tried to create more than 2000 major tick marks on a MinimalNumberAxis. "
    ...
    protected List<Number> calculateMinorTickMarks() {
        ...
        if (tickUnit > 0) {
            if (((upperBound - lowerBound) / minorUnit) > 10000) {
                // This is a ridiculous amount of major tick marks, something has probably gone wrong
                System.err.println("Warning we tried to create more than 10000 minor tick marks on a MinimalNumberAxis. "
    ...
    private static class StyleableProperties {
        ...
        private static final CssMetaData<MinimalNumberAxis, Number> TICK_UNIT
                = new CssMetaData<MinimalNumberAxis, Number>("-fx-tick-unit",
                        SizeConverter.getInstance(), 5.0) {

            @Override
            public boolean isSettable(MinimalNumberAxis n) {
                return n.tickUnit == null || !n.tickUnit.isBound();
            }

            @Override
            public StyleableProperty<Number> getStyleableProperty(MinimalNumberAxis n) {
        ...
        static {
            final List<CssMetaData<? extends Styleable, ?>> styleables
                    = new ArrayList<CssMetaData<? extends Styleable, ?>>(MinimalValueAxis.getClassCssMetaData());
    ...
    public static class DefaultFormatter extends StringConverter<Number> {
         ...
         */
        public DefaultFormatter(final MinimalNumberAxis axis) {
         ...
         */
        public DefaultFormatter(MinimalNumberAxis axis, String prefix, String suffix) {
            this(axis);
            this.prefix = prefix;
            this.suffix = suffix;
        }
